    ...
    <div className="max-w-[420px] mx-auto min-h-screen bg-gray-50">
      ...
      <div className="p-4">
        <div className="bg-white rounded-xl shadow-sm p-5 space-y-5">
          ...
          <div>
            <p className="text-sm text-gray-500 mb-1">Menu Item Name</p>
            <input
              value={name}
...
<div>
  ...
  <input
    ...
    className="w-full bg-gray-100 rounded-lg p-2 border border-gray-300 outline-none"
  />

  <p className="text-xs text-gray-400 mt-1">
    If item is free, enter 0
  </p>
</div>
  ...
  className="w-full bg-gray-100 rounded-lg p-3 border border-gray-300 focus:ring-2 focus:ring-[#103c7f] focus:border-[#103c7f] outline-none resize-none"
          ...
          >
            {loading ? "Saving..." : id ? "Update Menu Item" : "Save Menu Item"}
          </button>
